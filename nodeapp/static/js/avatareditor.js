/**
 *
 * @source: https://github.com/LocalPlay/PlayYourPlace/tree/master/htdocs/js/avatareditor.js
 *
...
function AvatarEditor(bounds,game) {
    var _this = this;
    this.game = game;
    ...
    //this.mediaviewer.setup(new Rectangle(0, bounds.height - 128, bounds.width, 128), new MediaLibrary('avatars.json'));
    ...
    this.mediaviewer.selectaction = function (item) { _this.setavatar(item); };
...
AvatarEditor.prototype.update = function () {
...
AvatarEditor.prototype.draw = function ( context ) {

}
AvatarEditor.prototype.onmousedown = function (evt) {
...
// actions
//
AvatarEditor.prototype.showhide = function () {
    if (this.hidden) {
...
AvatarEditor.prototype.setavatar = function (item) {
    this.game.level.replaceavatar(item.image.src);
}
